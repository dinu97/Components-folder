      ...
      this.innerHTML = `
        ...
        <div class=" cardPayments" id="cardId">
            ...
            <div class="px-3 pt-1 form-group">
                ...
                <input type="text" maxlength= "19"  name="number" id="formControlSm" class="form-control accountnumber" placeholder="1234 1234 1234 1234" onkeypress="cardspace()">
              
            </div>
           
            <div class="d-flex justify-content-between  px-3 pt-2 " id="datepicker">
                 <div class="form-group">
                     <label for="start" class="exptxt">Expiration</label>
                     <input type="text"  maxlength="7" id="card__input" name="trip-start" class="form-control start" placeholder="MM / YY" onkeypress="addslashes()">
            ...
            <div class="px-3 pt-2 form-group">
             ...
             <div class="form-group">
                <button type="submit" id="btnConfirm" class="btn btn-prima btn-block mb-3 pb-sm-2 pt-sm-2 ">confirm</button>
              </div>
              </div>
